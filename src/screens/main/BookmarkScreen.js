...
import NotificationCard from '../../components/NotificationCard'; // 알림 카드 컴포넌트 임포트
import { API_BASE_URL } from '../../../config/config'; // 서버 주소 import
import dummyNotifications from '../../../config/dummyNotifications'; // 더미데이터 import
...
const BookmarkScreen = ({ navigation }) => {
  ...
  const [notifications, setNotifications] = useState([]); // 서버 알림 리스트
